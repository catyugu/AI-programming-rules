...
1. **LEAST template(Except for fully static modules or cases) with MANDATORY concept(C++20) constraint for safety, NO lambda, No PCH, No macro define (Use constexpr if possible for type safety)**
